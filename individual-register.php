...
<body class="bg9" style="margin: 0px;">
    ...
    <nav class="navbar navbar-inverse">
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <button class="btn btn-danger navbar-btn" style="font-size: 15px; color: #FFFFFF; background-color: dimgrey; border: 1px solid #FFF9F9;"><a href="individual-signin.php" style="color: aliceblue; text-decoration: none">Login</a></button>
            </ul>
        </div>
    </nav>
    <div class="container1 text-center bg10">
        <br>
                ...
                <form class="form-horizontal" action="customer_script.php" method="post" enctype="multipart/form-data">
                    <h3><span class="glyphicon glyphicon-user lg"></span><br>Register and find your home for free</h3>
                    <br>
                    <div class="form-group">
                        <input type="text" class="form-control" name="name" placeholder="Your Name" required="true">
                    </div>
                    <div class="form-group">
                        <input type="email" class="form-control" name="email" placeholder="Enter Email Id" required="true" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="phone" placeholder="Enter Phone Number" required="true" maxlength="10" size="10"></div>
                    ...
                    <button type="submit" name="submit"><h4>Register</h4></button><br><br>
            </div><br>
            </form>
