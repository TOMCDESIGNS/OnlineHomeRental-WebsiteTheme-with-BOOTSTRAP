...
<head>
    ...
    <title>Individual Dashboard signin</title>
    <meta charset="utf-8">
...
<body class="bg9" style="margin: 0px;">
  ...
  <div class="container">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <button class="btn btn-danger navbar-btn" style="font-size: 15px; color: #FFFFFF; background-color: dimgrey; border: 1px solid #FFF9F9;"><a href="individual-register.php" style="color: aliceblue; text-decoration: none">REGISTER HERE</a></button>
    </ul>
  </div>
  </nav><br>
 ...
 <div class="row">
  ...
  <form action="isign_submit.php" method="post">
    ...
    <div class="form-group">
		<center><button type="submit" name="submit"><h4>Login</h4></button></center>
        </div>
</form>
 </div>
